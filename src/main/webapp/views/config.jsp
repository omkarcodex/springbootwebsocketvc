...
<body>
	...
	<div>
		...
		<h3 style="position: relative; left: 10px;">
			WebRTC Video Conferencing <br />Application Demo
		</h3>
	</div>
	...
	<div class="box">
		<button id="leaveButton"
			style="background-color: #008CBA; color: white;">Leave Video
			Conference</button>
	</div>

	<script type="text/javascript" src="/js/conf.js?reloads=true"></script>
